...
function battle() {
    ...
    $("#adminint").append('<div><label>Priority</label><select name="priority"><option value="1"' + sel[0] + '>Resistance, red flag (releasing)</option><option value="2"' + sel[1] + '>Resistance grey flag (keep)</option><option value="3"' + sel[2] + '>Direct grey flag</option><option value="4">Direct blue flag</option><option value="5">Direct green flag</option><option value="6">Direct red flag</option><option value="7">Direct black flag</option></select></div><div><label>Importance/wage</label><select name="importance"><option value="0" selected="">Grey/blue flag</option><option value="1">Green flag</option><option value="2">Red flag</option><option value="3">Black flag</option></select></div><div><button type="button" id="order">Set</button></div>');
    $('#order').on('click', function() {
        if (confirm("Comfirm to add this battle to the orders?")) {
            ...
            GM_xmlhttpRequest({
                ...
                onload: function(ret) {
                    if (ret.status == 200) {
                        alert("Battle set successfully.");
                    } else {
                        alert("! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! !\n\nYou aren't logged. Battle not saved!\n\n! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! ! !");
                    }
                },
                onerror: function() {
                    alert("Problem!");
